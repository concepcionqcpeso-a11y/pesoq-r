        ...
        <template v-if="!success">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input v-model="form.phone" type="tel" placeholder="09XX XXX XXXX" />
            </div>
          </div>
...
.card-header h3 {
  font-family: 'Playfair Display', serif; font-size: 26px; margin-bottom: 4px;
}
...
.form-group input {
  ...
  outline: none; color: var(--navy); transition: border-color .2s;
}
...
.check-tick {
  ...
  animation: draw-tick 0.4s ease 0.6s forwards;
}
@keyframes draw-circle { to { stroke-dashoffset: 0; } }
@keyframes draw-tick   { to { stroke-dashoffset: 0; } }
.success-box h3 {
  font-family: 'Playfair Display', serif;
  font-size: 26px; margin-bottom: 10px; color: var(--navy);
}
.success-box p {
